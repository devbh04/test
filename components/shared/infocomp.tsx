...
function InfoCard({ title, text, align }) {
    return (
      ...
      >
        {align === "left" && (
          <div className={"grid p-8 rounded-xl mr-48 ml-8 border-b-2 border-r-2 border-red-800 shadow-red-800 shadow-sm hover:shadow-red-800 hover:shadow-lg transition-shadow duration-300 ease-in-out"}>
            <div className="flex justify-center text-5xl">{title}</div>
            <div className="flex justify-center text-xl">{text}</div>
          </div>
        )}
        {align === "right" && (
          <div className={"grid p-4 rounded-xl ml-48 mr-8 border-b-2 border-l-2 border-red-800 shadow-red-800 shadow-sm hover:shadow-red-800 hover:shadow-lg transition-shadow duration-300 ease-in-out"}>
            <div className="flex justify-center text-5xl">{title}</div>
            {title === "3rd" ? (
              <>
...
export default function InfoCards() {
  ...
  return (
    <div className="mt-16 grid justify-center mb-40">
