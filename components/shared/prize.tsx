...
const Prize = () => {
  return (
    <div className='mb-16 p-4'>
        ...
        <div className='flex flex-col xl:flex-row gap-4 justify-center mt-8'>
            <div className='flex flex-col gap-4 bg-red-950 bg-opacity-20 border border-red-700 rounded-lg p-4 m-2 xl:w-max pt-20 pb-20 hover:bg-opacity-0'>
                ...
                <div className="flex flex-col gap-1">
                    <p className='flex justify-center '>CRTP Certification Voucher x 1</p>
        ...
        <div className='flex flex-col xl:flex-row gap-4 justify-center mt-8 xl:mx-72'>
            <div className='flex flex-col gap-4 bg-red-950 bg-opacity-20 border border-red-700 rounded-lg p-4 m-2 xl:w-max pt-20 pb-20 hover:bg-opacity-0'>
